...
<div class = "header2">
                ...
                <li>
                    <?php  if (isset($_SESSION['login'])) : ?>
                        <li>
                            ...
                            <ul class="logo">
                                <li><a href="user.php" class="regButton"><?php echo $_SESSION['login']; ?></a></li>
                    ...
                    <?php else: ?>
                        ...
                        <div class="popup">
                            <a class="close x" href="/~utemiadi/aia.kz">X</a>
    ...
    <script> $(window).scroll(function() { if ($(this).scrollTop() > 1){ $('.header-container2').addClass("sticky"); } else{ $('.header-container2').removeClass("sticky"); } });; </script>
</div>